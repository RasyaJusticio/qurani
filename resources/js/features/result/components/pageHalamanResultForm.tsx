    ...
    const handleChange = (key: keyof FormData, value: string) => {
        ...
        if (key == 'selected_first_surah') {
            if (!value) {
                ...
                form.setData('selected_first_ayah', props.labels.ayat[parseInt(value)][0].value);
            }
        }
        if (key == 'selected_last_surah') {
            if (!value) {
                ...
                form.setData('selected_last_ayah', props.labels.ayat[parseInt(value)][props.labels.ayat[parseInt(value)].length - 1].value);
            }
        }
    ...
    function generateVerseOptions(s: string): AyatOption[] {
        ...
        if (s == 'awal') {
            ...
            if (!form.data.selected_first_surah) {
                ...
                verses = props.labels.ayat[parseInt(form.data.selected_first_surah)];
            }
            return verses;
        } else {
            let verses;
            if (!form.data.selected_last_surah) {
                ...
                verses = props.labels.ayat[parseInt(form.data.selected_last_surah)];
            }
            return verses;
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-6 dark:bg-[rgb(16,24,40)]">
            <div className="mx-auto mt-12 w-full max-w-4xl px-4 sm:px-6 lg:px-8">
                <Alert show={alert} setAlert={setAlert} to='/home' heading='Data Berhasil Dikirim' message='Lihat Detail Recap pada tabel' />
